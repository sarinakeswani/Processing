...
void setup() {
  ...
  PImage friends = loadImage("face-1.jpg");  // 2. Change this to match the name of your photo. 
...
background(friends);
  ...
  mustache = loadImage("moustache-clipart-mustache-clipart-2400_1034.png"); // 5. Change this to match your file name.
}
